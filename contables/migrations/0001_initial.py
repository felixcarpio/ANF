# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2019-11-22 04:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateField(auto_now_add=True, help_text='Formato: AAAA/MM/DD', verbose_name='Fecha de Contratacion')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debe', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='debe')),
                ('haber', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='haber')),
                ('utilidades', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Utilildad')),
                ('utilidadNeta', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Utilildad')),
            ],
        ),
        migrations.CreateModel(
            name='Final',
            fields=[
                ...
                ('es_Actual', models.NullBooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
            name='Kardex',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salarioNominal', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Salario Nominal')),
                ('insaforp', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='INSAFORP')),
                ('aguinaldo', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Aguinaldo')),
                ('dui', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contables.Empleado')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('porcentajeGanancia', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='haber')),
                ('precioVenta', models.DecimalField(decimal_places=2, max_digits=50, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='haber')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_inicial', models.NullBooleanField()),
